...
public class ShowAllTaxis_for_OfficeActivity extends AppCompatActivity {
...
//                    intent.getStringExtra(MyService.MY_SERVICE_PAYLOAD);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_show_all_taxis_for__office);
    ...
    private void initRecylceView()
    {
        ...
        taxisAdapter=new TaxisAdapter(allTaxi,this);
        all_taxi_recyclerView.setAdapter(taxisAdapter);
