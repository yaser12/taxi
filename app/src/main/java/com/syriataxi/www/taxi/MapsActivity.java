...
//                    intent.getStringExtra(MyService.MY_SERVICE_PAYLOAD);
    ...
    if(OfficeJsonFetcherService.GET_ALL_OFFICE_PAYLOAD==null)
    {
        ...
        Toast.makeText(MapsActivity.this,"يبدو ان اتصال الانترنت ضعيف.. اعد المحاولة لاحقا",Toast.LENGTH_SHORT).show();
    }
    else
        {
...
//
                ...
                if (networkOk) {
                    Intent intent = new Intent(MapsActivity.this, OfficeJsonFetcherService.class);
