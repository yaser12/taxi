...
import androidbootstrap.BootstrapButton;
...
public class RealLocationActivity extends AppCompatActivity {
    ...
    private BootstrapButton add_new_taxi_to_office,show_all_taxi_for_office_idbtnButton;
    private Button mStopUpdatesButton;
    private TextView mLastUpdateTimeTextView;
    private TextView mLatitudeTextView;
    private TextView mLongitudeTextView,office_nameTxt;
...
//        setSupportActionBar(toolbar);
    ...
    public void go_to_add_new_office_activty(View view) {
        startActivity(new Intent(RealLocationActivity.this, AddNewOfficeActivity.class));
    }

    public void add_new_taxi_to_my_office(View view) {
        startActivity(new Intent(RealLocationActivity.this, AddNewTaxiActivity.class));
    }

    public void show_all_taxi_for_office_idClick(View view) {
        startActivity(new Intent(RealLocationActivity.this, ShowAllTaxis_for_OfficeActivity.class));
    }
}
