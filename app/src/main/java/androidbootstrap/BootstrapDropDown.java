...
import androidbootstrap.api.defaults.ExpandDirection;
...
import androidbootstrap.utils.DrawableUtils;
...
public class BootstrapDropDown extends AwesomeTextView implements View.OnClickListener, RoundableView, OutlineableView, PopupWindow.OnDismissListener {
    ...
    private static final String TAG = "androidbootstrap.BootstrapDropDown";
    private static final String KEY_DIRECTION = "androidbootstrap.BootstrapDropDown.EXPAND_DIRECTION";
