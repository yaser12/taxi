...
import static androidbootstrap.api.attributes.ViewGroupPosition.BOTTOM;
import static androidbootstrap.api.attributes.ViewGroupPosition.END;
import static androidbootstrap.api.attributes.ViewGroupPosition.MIDDLE_HORI;
import static androidbootstrap.api.attributes.ViewGroupPosition.MIDDLE_VERT;
import static androidbootstrap.api.attributes.ViewGroupPosition.SOLO;
import static androidbootstrap.api.attributes.ViewGroupPosition.START;
import static androidbootstrap.api.attributes.ViewGroupPosition.TOP;
...
public class BootstrapButtonGroup extends BootstrapGroup implements BootstrapSizeView,
    ...
    private static final String TAG = "androidbootstrap.BootstrapButtonGroup";
    private static final String KEY_MODE = "androidbootstrap.BootstrapButtonGroup.MODE";
