...
import androidbootstrap.api.view.BadgeContainerView;
...
public class BootstrapButton extends AwesomeTextView implements BootstrapSizeView,
    ...
    private static final String TAG = "androidbootstrap.BootstrapButton";
    private static final String KEY_MODE = "androidbootstrap.BootstrapButton.MODE";
    private static final String KEY_INDEX = "androidbootstrap.BootstrapButton.KEY_INDEX";
