...
public interface ProgressView {
    ...
    String KEY_USER_PROGRESS = "androidbootstrap.api.view.KEY_USER_PROGRESS";
    String KEY_DRAWN_PROGRESS = "androidbootstrap.api.view.KEY_DRAWN_PROGRESS";
    String KEY_STRIPED = "androidbootstrap.api.view.KEY_STRIPED";
    String KEY_ANIMATED = "androidbootstrap.api.view.KEY_ANIMATED";
